...
| **Field** | **Description** |
| --- | --- |
| **Last Active** | When the session was last used (e.g., *about 23 hours ago*). |
| **Location** | Country code where the login originated (e.g., US). |
...
If you notice unfamiliar activity, it’s recommended to change your password immediately.