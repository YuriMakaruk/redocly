...
| --- | --- | --- |
| **Starter** | Default plan with percentage-based billing fees. | Active |
| **Enterprise** | Custom pricing and features for large-scale businesses. | **Talk to us** |
...
| **Field** | **Description** |
| --- | --- |
| **Bank account** | The connected bank account, displayed in masked format (e.g., **Chase ••••0000**). |
...
- Bank account updates may require verification before becoming active.